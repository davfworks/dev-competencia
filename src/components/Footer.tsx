...
import { Bike, Mail, Phone, MessageCircle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
        ...
        <div>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 bg-green-600 hover:bg-green-500 text-white font-bold uppercase px-6 py-4 transition-colors w-full md:w-auto md:inline-flex"
          >
            <MessageCircle size={20} />
            WhatsApp
          </a>
          <p className="text-zinc-500 text-sm mt-4 text-center md:text-left">{footer.whatsapp}</p>
        </div>
      </div>
